            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        <li class="active"><a href="index-entro.php">Informacion del docente <span class="sr-only">(current)</span></a></li>         
                    </ul>
                    <ul class="nav nav-sidebar">            
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">Información del docente</h1>
                    ...
                    <div class="container">
                        <div class="col-sm-6 col-md-4 text-center">
                              <div class="well well-lg">
                                  <section>
                                    ...
                                    <img class="img-circle" src=" ../../img/docente.jpg" alt="Generic placeholder image" width="200" height="160">
                        ...
                        <?php                                
                                ...
                                include '../../controladores/docenteController.php';
         
                                $cbLanguageController = new docenteController();
                                $cbLanguageController->cdb = $cdb; 

                                $doc = $cbLanguageController->buscarDocente($_SESSION['codigoDocente']);
                              ...
                              <div class="caption ">
                                  ...
                                  <table class="table table-hover">
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $_SESSION['codigoDocente']?></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo ($doc[0]->correo);  ?></td>
                                      </tr>
                                      <tr>
                                        <td><strong>Cuenta: </strong></td>
                                        <td><a href="<?php echo ($doc[0]->cuenta);  ?>"><?php echo ($doc[0]->cuenta);  ?></a></td>
                                      </tr>
                   ...
                   <div class="col-sm-6 col-md-12">
                    ...
                    <body  ng-controller="gitHubDataController">
                        ...
                        <script src="../../lib/docente/lib/angular/angular.min.js" charset="utf-8"></script>
                        <script src="../../lib/docente/app/app.js" charset="utf-8"></script>
